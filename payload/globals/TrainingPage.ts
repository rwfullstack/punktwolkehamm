...
export const TrainingPageGlobal: GlobalConfig = Global_Options(
    "TrainingPage",
    "Schulungen",
    {
        admin: {
    ...
    [
        ...
        NAMED_GROUP_FIELD("Sektion 2", "information", [
            COLLAPSIBLE_FIELD("Sektion 2", [
                ...
                ARRAY_FIELD("Details", "details", [ROW_FIELD([TEXT_AREA_FIELD("Detail", "detail")])]),
        ...
        NAMED_GROUP_FIELD("Sektion 5", "richtext", [
