...
export const InspectionPageGlobal: GlobalConfig = Global_Options(
    "InspectionPage",
    "Inspektion",
    {
        admin: {
    ...
    [
        ...
        NAMED_GROUP_FIELD("Sektion 2", "information", [
        ...
        NAMED_GROUP_FIELD("Sektion 5", "usages", [
            COLLAPSIBLE_FIELD("Sektion 5", [
                ...
                ARRAY_FIELD("Anwendungsbereiche", "usages", [
                    TEXT_AREA_FIELD("Titel", "title"),

                    ARRAY_FIELD("Liste", "list", [TEXT_AREA_FIELD("Text", "text")])
                ])
            ])
        ]),
        ...
        NAMED_GROUP_FIELD("Sektion 6", "benefits", [
            COLLAPSIBLE_FIELD("Sektion 6", [
                ...
                ARRAY_FIELD("Anwendungsbereiche", "benefits", [TEXT_AREA_FIELD("Vorteil", "benefit")])
            ])
        ]),
