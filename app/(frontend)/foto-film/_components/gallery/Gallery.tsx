            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-5 px-3">
                ...
                <div className="mt-15 grid grid-cols-1 gap-5 md:grid-cols-3 md:grid-rows-2">
                    <div className="relative overflow-hidden rounded-3xl object-cover shadow-md transition-all duration-300 ease-in-out hover:scale-102 hover:shadow-lg md:col-span-2 md:row-span-2">
                        ...
                        <div className="absolute top-0 left-0 flex size-full items-center justify-center bg-linear-to-b from-[#053070]/5 via-[#0D083F]/5 to-[#0D083F]">
                            <Link href={content?.gallery?.link ?? ""} target="_blank" rel="noopener noreferrer">
                                <button className="rounded-xl bg-[#2177E8] px-5 py-2 text-white shadow-md transition-all duration-250 hover:scale-105 hover:shadow-lg">
                                    Anschauen
                                </button>
                            </Link>
                        </div>
