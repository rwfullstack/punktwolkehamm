            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-x-10 gap-y-5 px-3 md:flex-row">
                ...
                <div className="flex flex-2 flex-col gap-5 self-start">
                    <ViewAnimation type="Leftwards" delay={100} className="h-full w-full">
                        <div className="flex flex-col gap-5 rounded-3xl border border-gray-100 bg-[#2177E8]/20 p-5 px-8 py-12 shadow-md transition-all duration-300 ease-in-out hover:scale-102 hover:border-[#2177E8]/50 hover:shadow-lg">
                            ...
                            <div className="grid gap-x-6 gap-y-4 md:grid-cols-2">
                                <ViewAnimation type="Upwards" delay={0} className="w-full">
                                ...
                                <ViewAnimation type="Upwards" delay={80} className="w-full">
                                    <div className="flex flex-col items-center gap-1 rounded-xl bg-white py-4">
                                        <h4 className="text-3xl font-semibold text-[#2177E8]">
                                ...
                                <ViewAnimation type="Upwards" delay={160} className="w-full">
                                    <div className="flex flex-col items-center gap-1 rounded-xl bg-white py-4">
                                        <h4 className="text-3xl font-semibold text-[#2177E8]">
                                ...
                                <ViewAnimation type="Upwards" delay={240} className="w-full">
                                    <div className="flex flex-col items-center gap-1 rounded-xl bg-white py-4">
                                        <h4 className="text-3xl font-semibold text-[#2177E8]">
